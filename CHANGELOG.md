...
- **Flatpak WebKitGTK startup compatibility** - Use the stable GNOME Platform 49 runtime while WebKitGTK 2.52 startup crashes are investigated, and smoke-test the packaged app under Xvfb in CI
