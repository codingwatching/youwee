      ...
      >
        ...
        <div className="flex items-center h-14 px-3 border-b">
          <div className="flex items-center gap-2 overflow-hidden">
            <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-gradient-to-br from-[hsl(var(--gradient-from))] via-[hsl(var(--gradient-via))] to-[hsl(var(--gradient-to))] flex items-center justify-center shadow-lg">
              <svg 
                viewBox="0 0 24 24" 
